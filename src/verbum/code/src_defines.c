...
"bool parser_match_any2(Parser *p, const char **tls, size_t n);\n"
"\n"
...
"\n"
"AST *parser_parse(Parser *p) {\n"
"	%s *s = parser_parse_internal(p);\n"
"	AST *result = p->ctx->memory.copy(&s, sizeof(*result));\n"
"\n"
"	return result;\n"
"}\n"
"\n"
